...
// Fetch data from the database for Kisumu County
...
<head>
    ...
    <title>Line Graph showing Malaria Cases in Kisumu</title>
...
<figure class="highcharts-figure">
    ...
    <p class="highcharts-description">
        Line chart showing trends in malaria cases in Kisumu County.
    </p>
</figure>
...
<script type="text/javascript">
    Highcharts.chart('container1', {
        title: {
            text: 'Malaria Cases in Kisumu County',
            align: 'left'
        },
        subtitle: {
