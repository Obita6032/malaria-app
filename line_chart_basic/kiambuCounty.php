...
// Fetch data from the database for Kiambu County
$sql = 'SELECT name, year, data FROM counties WHERE name = :countyName';
$countyName = 'Kiambu'; // Specify the county name
...
<head>
    ...
    <title>Line Graph showing Malaria Cases in Kiambu</title>
...
<figure class="highcharts-figure">
    ...
    <p class="highcharts-description">
        Line chart showing trends in malaria cases in Kiambu County.
    </p>
</figure>
...
<script type="text/javascript">
    Highcharts.chart('container1', {
        title: {
            text: 'Malaria Cases in Kiambu County',
            align: 'left'
        },
        subtitle: {
